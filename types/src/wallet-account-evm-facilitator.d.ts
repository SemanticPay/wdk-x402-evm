 ...
 */
export default class WalletAccountEvmFacilitator implements FacilitatorEvmSigner {
    /**
...
export type FacilitatorEvmSigner = {
     ...
     * - Write to a contract.
     */
    writeContract: (args: WriteContractArgs) => Promise<string>;
    /**
     * - Send a raw transaction.
     */
     ...
     */
    getCode: (args: GetCodeArgs) => Promise<string | undefined>;
};
